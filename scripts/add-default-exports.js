...
const modules = [
  ...
  {
    file: 'number.ts',
    exports: ['HEX_POOL', 'numberToHex', 'numberAbbr', 'humanFileSize', 'formatNumber', 'formatMoney']
  },
  ...
  { file: 'func.ts', exports: ['debounce', 'throttle', 'once'] },
  ...
  {
    file: 'variable.ts',
    exports: ['escapeRegExp', 'executeInScope', 'parseVarFromString', 'replaceVarFromString', 'uniqueSymbol']
  },
